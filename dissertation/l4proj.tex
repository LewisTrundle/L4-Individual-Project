...
\begin{figure}[!ht]
    ...
    \end{subfigure}
    \caption{Figure showing different markers used for marker detection. \subref{fig:qr-code} shows a QR-code. \subref{fig:aruco-marker} shows an ArUco marker.}
    \label{fig:markers}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \end{subfigure}
    \caption{Screenshots taken of the video feed, showing the colour-tracking feature for different coloured objects. The screenshots show a moderate brightness level which was best for colour-tracking to work. \subref{fig:colour-tracking-black} shows the colour-tracker, tracking the colour black. However, due to a high level of tolerance, it cannot only identify the singular black object held in the scene, but it also identifies other colours close to black, leading to poor accuracy. Colour tracking for red \subref{fig:colour-tracking-red}, green \subref{fig:colour-tracking-green}, and blue \subref{fig:colour-tracking-blue} work somewhat well. However, this is largely dependent on the brightness levels of the scene, and any slight deviation from the colours shown here can cause inaccuracy in detection.}
...
\begin{figure}[!ht]
    ...
    \end{subfigure}
    \caption{Screenshots taken of the video feed, showing the colour-conversion feature for different coloured objects. \subref{fig:colour-conversion-black-after} shows greyscale conversion, to highlight black objects. \subref{fig:colour-conversion-red-after} highlights the red object but also has a low tolerance so highlights other colours as well. \subref{colour-conversion-green-after} highlights green and performs the best. \subref{fig:colour-conversion-blue-after} highlights blue, but has a low accuracy, causing little blue to be highlighted.}
